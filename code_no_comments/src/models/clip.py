...
from src.models.base.clip_base import build_model
from src.models.base.clip_tokenize import SimpleTokenizer as _Tokenizer
try:
...
def load(name: str, q_aware_N: int, device: Union[str, torch.device]='cuda' if torch.cuda.is_available() else 'cpu', jit: bool=False, download_root: str=None):
    if name in _MODELS:
